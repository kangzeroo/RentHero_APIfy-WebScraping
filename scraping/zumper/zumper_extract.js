...
const CRAWLER_ID = 'XpH7SWjLYWLzt6Rzo'
const CRAWLER_EXEC_TOKEN = 'AipGEm8BJ3JaMwLeEDFSkkFcR'

// NODE_ENV=development node ./scripts/zumper/zumper_ad_extraction.js

const ZUMPER_AD_LIST = require('./data/zumper_ad_list.json')
console.log("=========> STARTING SCRIPT...")
// ZUMPER_AD_LIST.map((ad) => {
//   console.log(ad)
// })
...
/*
  ...
  // start urls should be dynamically retrieved from the imported "zumper_ad_list.json"
...
// }
const PAYLOAD_UPDATE_CRAWLER = {
  "startUrls": ZUMPER_AD_LIST.slice(1100).map((ad, i) => {
    return {
      key: ad.zumper_id,
      value: ad.ad_url
    }
...
console.log(PAYLOAD_UPDATE_CRAWLER)
